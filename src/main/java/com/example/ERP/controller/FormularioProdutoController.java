...
public class FormularioProdutoController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        com.example.erp.utils.MaskUtils.applyMoneyMask(txtPrecoVenda);
        valido.set(false);
    }
    ...
    public boolean validate() {
        ...
        if (precoText == null || precoText.trim().isEmpty()) {
            ...
            try { com.example.erp.utils.NumberUtils.parseDoubleFromPtBR(precoText.trim()); } catch (NumberFormatException e) { errors.add("Preço inválido: '" + precoText + "'"); }
        }
    ...
    private double parseDoubleFromPtBR(String text) throws NumberFormatException {
        ...
        return com.example.erp.utils.NumberUtils.parseDoubleFromPtBR(text);
    }
}
